...
A detail instruction on how to setup these systems are already well documented in their own repositories, please check the [Frontend](https://github.com/Hankaji/GDGDoc-Aegis-Frontend), [Backend](https://github.com/DankoFox/aegis-backend) and [AI](https://github.com/nmquan1/aegis-pipeline) for more details.
